...
if(keyboard_check_pressed(vk_space))
{
	...
	{
		object_set_sprite(obj_title1,Sp_Platform1)
		
	}
	else if(object_get_sprite(obj_title2) == -1)
	{
			object_set_sprite(obj_title2,Sp_Platform1)
	}
	else if(object_get_sprite(obj_title3) == -1)
	{
			object_set_sprite(obj_title3,Sp_Platform1)
	}
	else if(object_get_sprite(obj_title4) == -1)
	{
			object_set_sprite(obj_title4,Sp_Platform1)
	}
	else if(object_get_sprite(obj_title5) == -1)
	{
			object_set_sprite(obj_title5,Sp_Platform1)
	}
	else if(object_get_sprite(obj_title6) == -1)
	{
			object_set_sprite(obj_title6,Sp_Platform1)
	}
	...
	{
			object_set_sprite(obj_title8,Sp_Platform1)
	}
	else if(object_get_sprite(obj_title9) == -1)
	{
			object_set_sprite(obj_title9,Sp_Platform1)
	}
	else if(object_get_sprite(obj_title10) == -1)
	{
			object_set_sprite(obj_title10,Sp_Platform1)
	}
	else if(object_get_sprite(obj_title11) == -1)
	{
			object_set_sprite(obj_title11,Sp_Platform1)
	}
	else if(object_get_sprite(obj_title12) == -1)
	{
		object_set_sprite(obj_title12,Sp_Platform1)
	}
